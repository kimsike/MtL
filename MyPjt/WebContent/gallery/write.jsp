				...
				<div class="container">
					...
					<div class="l-section">
						<div class="page-header">
							<h1 class="h" style="width: 150px; height: 30px; margin-bottom: 30px; font-weight: bold;">글쓰기</h1>	
							<div style="text-align: right;" >
								<input type="button" value="글 목록" onclick="location.href='gallery.jsp'" class="btn btn-b">
							</div>
						</div>
						
						<form action="writePro.jsp" method="post" name="writeForm" class="board-write">						
							<!-- filepath : 이미지업로드 경로 -->
							...
							<table class="table">
								...
								<tbody>
									<tr>
										<th>제목</th>
										<td>
											<input type="text" name="title" placeholder="제목을 입력해 주세요." class="text text-max">
										</td>
									</tr>
									<tr>
										<th>내용</th>
										<td>
											<textarea name="content" id="textAreaContent" style="width: 100%" class="text-max" placeholder="내용을 입력해 주세요."></textarea>
										</td>
									</tr>
